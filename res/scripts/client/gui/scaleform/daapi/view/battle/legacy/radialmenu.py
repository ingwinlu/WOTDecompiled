...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/RadialMenu.py
...
class RadialMenu(UIInterface):
        ...
        if cmdMap.isFired(CommandMapping.CMD_RADIAL_MENU_SHOW, key):
            if isDown:
                ...
                if self.__currentVehicleDesc is not None:
                    ...
                    self.__onMenuShow(mouseUsedForShow)
            else:
                self.__onMenuHide()
        elif isDown:
    ...
    def __onRespawnVisibilityChanged(self, flag):
        if flag:
            self.__onMenuHide()
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/radialmenu.pyc
