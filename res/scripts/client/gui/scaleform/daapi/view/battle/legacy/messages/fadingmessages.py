...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/messages/FadingMessages.py
from account_helpers.settings_core import g_settingsCore
from debug_utils import LOG_DEBUG, LOG_CURRENT_EXCEPTION
from gui.battle_control import g_sessionProvider
from gui.doc_loaders import messages_legacy_reader
...
class FadingMessages(object):
    ...
    def __onPopulateUI(self, requestID):
        settings, self.__messages = messages_legacy_reader.readXML(self.__cfgFileName)
        args = [requestID]
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/messages/fadingmessages.pyc
