...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/messages/VehicleMessages.py
...
class VehicleMessages(FadingMessages):
    ...
    def __init__(self, parentUI):
        super(VehicleMessages, self).__init__(parentUI, 'VehicleMessagesPanel', 'gui/legacy_vehicle_messages.xml')
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/messages/vehiclemessages.pyc
