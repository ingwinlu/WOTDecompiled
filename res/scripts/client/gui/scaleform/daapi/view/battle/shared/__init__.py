...
class BattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = ((VIEW_ALIAS.INGAME_MENU, self.__handleIngameMenuEvent), (events.GameEvent.HELP, self.__handleHelpEvent))
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/shared/__init__.pyc
