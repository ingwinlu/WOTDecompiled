...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/respawn_view.py
import BigWorld
import nations
from gui import makeHtmlString
from gui.Scaleform.daapi.view.battle.legacy.meta.BattleRespawnViewMeta import BattleRespawnViewMeta
...
class _BattleRespawnView(BattleRespawnViewMeta, IRespawnView):
    ...
    def py_vehicleSelected(self, vehicleID):
        ...
        if ctrl is not None:
            ctrl.chooseVehicleForRespawn(vehicleID)
        return
...
class RespawnViewPlugin(IPlugin):
    ...
    def stop(self):
        g_sessionProvider.removeViewComponent('fallout/respawn')
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/respawn_view.pyc
