...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/resource_points.py
import weakref
import BigWorld
...
class ResourcePointsPlugin(IPlugin):
    ...
    def __onOwnVehicleLocked(self, unlockTime):
        ...
        if unlockTime is not None:
            ...
            self.__resourceIndicator.setFreeze(False, '')
        return
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/resource_points.pyc
