...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/flag_notification.py
import weakref
...
class _NOTIFICATION_TYPE(object):
    FLAG_CAPTURED = 0
    FLAG_DROPPED = 1
    FLAG_DELIVERED = 2
    FLAG_ABSORBED = 3
...
class FlagNotificationPlugin(IPlugin):
    ...
    def stop(self):
        g_sessionProvider.removeViewComponent('fallout/flagsNots')
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/flag_notification.pyc
