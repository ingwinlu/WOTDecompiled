...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/meta/BattleComponentMeta.py
...
class BattleComponentMeta(object):
    ...
    def _dispose(self):
        if self._flashObject is not None:
            ...
            self._flashObject = None
        return
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/meta/battlecomponentmeta.pyc
