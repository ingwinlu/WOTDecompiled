...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/legacy/teams_bases_panel.py
...
class TeamBasesPanel(team_bases_ctrl.ITeamBasesPanel):
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/battle/legacy/teams_bases_panel.pyc
