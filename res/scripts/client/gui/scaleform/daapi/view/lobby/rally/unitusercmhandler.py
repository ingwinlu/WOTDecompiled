...
class UnitUserCMHandler(BaseUserCMHandler, UnitListener):
    ...
    def _addSquadInfo(self, options, isIgnored):
        if self.unitFunctional.getEntityType() not in PREBATTLE_TYPE.SQUAD_PREBATTLES:
...
# okay decompiling ./res/scripts/client/gui/scaleform/daapi/view/lobby/rally/unitusercmhandler.pyc
