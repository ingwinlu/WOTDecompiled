...
class FUNCTIONAL_FLAG(BitmaskHelper):
    ...
    SANDBOX = 2097152
    FALLOUT_BATTLES = 4194304
    FALLOUT_BATTLES_INTRO = 8388608
    ...
    UNIT_BITMASK = NO_UNIT | UNIT_INTRO | UNIT | SQUAD | FALLOUT_SQUAD
    PRE_QUEUE_BITMASK = NO_QUEUE | PRE_QUEUE | RANDOM_BATTLES | EVENT_BATTLES | BATTLE_TUTORIAL | SANDBOX | FALLOUT_BATTLES
    RANGE = (UNDEFINED,
     LEAVE_ENTITY,
     LEAVE_INTRO,
     LEAVE_PRE_QUEUE,
...
class PREBATTLE_ACTION_NAME(object):
    ...
    FALLOUT_QUEUE = 'joinFalloutQueue'
...
PREBATTLE_ACTION_NAME_TO_QUEUE_TYPE = {PREBATTLE_ACTION_NAME.RANDOM_QUEUE: QUEUE_TYPE.RANDOMS,
 PREBATTLE_ACTION_NAME.FALLOUT: QUEUE_TYPE.UNKNOWN,
 PREBATTLE_ACTION_NAME.FALLOUT_CLASSIC: QUEUE_TYPE.FALLOUT_CLASSIC,
 PREBATTLE_ACTION_NAME.FALLOUT_MULTITEAM: QUEUE_TYPE.FALLOUT_MULTITEAM,
 PREBATTLE_ACTION_NAME.BATTLE_TUTORIAL: QUEUE_TYPE.TUTORIAL,
 PREBATTLE_ACTION_NAME.SANDBOX: QUEUE_TYPE.SANDBOX}
...
class PRB_INVITE_STATE(CONST_CONTAINER):
    ...
    def getFromNewState(cls, invite):
        if invite.isExpired():
            return cls.EXPIRED
        return invite.state
# okay decompiling ./res/scripts/client/gui/prb_control/settings.pyc
