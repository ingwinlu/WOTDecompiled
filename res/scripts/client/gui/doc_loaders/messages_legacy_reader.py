...
# Embedded file name: scripts/client/gui/doc_loaders/messages_legacy_reader.py
...
_cache = _initCache('gui/legacy_player_messages.xml', 'gui/legacy_vehicle_errors.xml', 'gui/legacy_vehicle_messages.xml')
...
def readXML(path):
    ...
    _cache[path] = result
    return result
# okay decompiling ./res/scripts/client/gui/doc_loaders/messages_legacy_reader.pyc
