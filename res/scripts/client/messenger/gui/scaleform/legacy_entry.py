...
# Embedded file name: scripts/client/messenger/gui/Scaleform/legacy_entry.py
import Keys
import VOIP
...
class LegacyBattleEntry(IGUIEntry):
...
# okay decompiling ./res/scripts/client/messenger/gui/scaleform/legacy_entry.pyc
