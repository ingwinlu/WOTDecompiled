...
def isPointOnScreen(point):
    ...
    if (posInClip.w != 0 and -1) <= posInClip.x / posInClip.w <= 1:
        return -1 <= posInClip.y / posInClip.w <= 1 and True
    return False
...
# okay decompiling ./res/scripts/client/avatarinputhandler/cameras.pyc
