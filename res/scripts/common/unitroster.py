...
Instruction context:
 ...
 536     138  LOAD_FAST             5  'vehicleLevelLimits'
            141  LOAD_CONST            0  ''
...
class BaseUnitRosterLimits(object):
 ...
 527       0  LOAD_FAST             0  'self'
           3  LOAD_ATTR             0  'mask'
           6  LOAD_CONST            1  ''
           9  COMPARE_OP            2  '=='
          12  POP_JUMP_IF_FALSE    19  'to 19'

 528      15  LOAD_GLOBAL           1  'True'
          18  RETURN_END_IF    

 529      19  LOAD_FAST             0  'self'
          22  LOAD_ATTR             2  'limits'
          25  LOAD_ATTR             3  'get'
          28  LOAD_CONST            2  'vehicleLevelLimitsByClass'
          31  LOAD_CONST            0  ''
          34  CALL_FUNCTION_2       2 
          37  STORE_FAST            3  'vehicleLevelLimitsByClass'

 530      40  LOAD_FAST             3  'vehicleLevelLimitsByClass'
          43  LOAD_CONST            0  ''
          46  COMPARE_OP            9  'is not'
          49  POP_JUMP_IF_FALSE   117  'to 117'

 531      52  LOAD_FAST             3  'vehicleLevelLimitsByClass'
          55  LOAD_ATTR             3  'get'
 ...
 532      70  LOAD_FAST             4  'vehicleLevelClassLimits'
          73  LOAD_CONST            0  ''
          76  COMPARE_OP            9  'is not'
          79  POP_JUMP_IF_FALSE   117  'to 117'

 533      82  LOAD_FAST             4  'vehicleLevelClassLimits'
          85  LOAD_CONST            1  ''
          88  BINARY_SUBSCR    
 ...
 534     117  LOAD_FAST             0  'self'
         120  LOAD_ATTR             2  'limits'
         123  LOAD_ATTR             3  'get'
         126  LOAD_CONST            4  'vehicleLevelLimits'
         129  LOAD_CONST            0  ''
...
scripts/common/UnitRoster.py

# okay decompiling ./res/scripts/common/unitroster.pyc
